...
module.exports = {
  ...
  BADOL: async function ({ event, api, args, message, chatId, userId }) {
    ...
    if (!keyword) {
      return api.sendMessage(chatId, `╭─❖─〔 EREN-AI-BOT 〕─❖─╮\n│ ⚠️ Use: /video dil dil\n│ ⚠️ Use: /video Believer\n╰─❖─〔 EREN-AI-BOT 〕─❖─╯`, {
    ...
    let waitMsg = null;
    try {
      waitMsg = await api.sendMessage(chatId, `╭─❖─〔 EREN-AI-BOT 〕─❖─╮\n│ 🔍 Searching: ${safeName(keyword, 20)}\n│ ⏳ Finding 5 videos...\n╰─❖─〔 EREN-AI-BOT 〕─❖─╯`, {
        reply_to_message_id: event.message_id
      });
    } catch {}
  ...
  onCallback: async function ({ event, api, ctx }) {
    ...
    try {
      ...
      try {
        await ctx.editMessageText(`╭─❖─〔 EREN-AI-BOT 〕─❖─╮\n│ 🎬 Selected: ${safeName(video.title, 25)}\n│ ⏳ Downloading...\n│ 🔗 ${videoUrl}\n╰─❖─〔 EREN-AI-BOT 〕─❖─╯`, {
