...
module.exports = {
  ...
  BADOL: async function ({ event, api, message }) {
    ...
    try {
        ...
        ctx.fillText("QUANTUM SYSTEM V5",400,75); ctx.shadowBlur=0;
        ...
        try {
            ...
            if (file && file.photos && file.photos[0]) {
        ...
        drawBox(420,130,330,85,"BOT NAME","EREN-AI-BOT","#00f2fe");
        ...
        await api.sendPhoto(chatId, { source: fs.createReadStream(imgPath) }, { caption: captionText });
